Shader "Phos/InteractDevice/PressurePlate"
{
    Properties
    {
        _MainTex ("Albedo", 2D) = "white" {}
        _Color ("Color", Color) = (1,0.2,0.2,1)
        _PatternColor ("Pattern Color", Color) = (0.5,0,0,1)
    ...
    SubShader
    {
        ...
        void surf(Input IN, inout SurfaceOutputStandard o)
        {
            ...
            fixed4 c = lerp(_Color, _PatternColor, step(mask.r, 0.5));
            c *= phos_gradient(IN.screenPos.y);
            o.Albedo = c.rgb;
            o.Metallic = 0;
            o.Smoothness = 0;
            o.Alpha = c.a;
